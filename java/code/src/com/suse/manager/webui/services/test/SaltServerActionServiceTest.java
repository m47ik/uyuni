...
public class SaltServerActionServiceTest extends JMockBaseTestCaseWithUser {
    ...
    public void testPackageUpdate() throws Exception {
        ...
        Map<LocalCall<?>, List<MinionIds>> result = SaltServerActionService.INSTANCE.callsForAction(updateAction, minionIds, false);
    ...
    public void testDeployFiles() throws Exception {
        ...
        Map<LocalCall<?>, List<MinionIds>> result =
                SaltServerActionService.INSTANCE.callsForAction(configAction, false);
    ...
    public void testVirtACtions() throws Exception {
        ...
        List<MinionIds> minionIds = Arrays.asList(new MinionIds(minionHost));
        ...
        for (ActionType type : actionTypes) {
            ...
            Map<LocalCall<?>, List<MinionIds>> result = SaltServerActionService.INSTANCE.callsForAction(action, minionIds, false);
